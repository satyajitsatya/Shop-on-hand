...
let pdistress = document.getElementById("p-distress")
...
product.forEach(function(value){
    value.addEventListener("click",()=>{
        ...
        let pdfade = value.childNodes[17].textContent;
        let pddistress = value.childNodes[19].textContent;
        ...
        pdistress.innerText = pddistress
    })
})